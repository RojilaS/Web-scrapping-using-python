...
laptop_containers = soup.find_all('div', {'class': '_2kHMtA'})
# Create a CSV file to store the product details
csv_filename = 'flipkart_laptop_products.csv'
...
with open(csv_filename, 'w', newline='', encoding='utf-8') as csv_file:
    ...
    # Loop through each laptop container and extract product details
